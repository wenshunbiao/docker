...
RUN echo 'composer config -g repo.packagist composer https://packagist.phpcomposer.com' > /usr/bin/cn-composer
RUN echo 'composer config -g repo.packagist composer https://packagist.org' > /usr/bin/en-composer
